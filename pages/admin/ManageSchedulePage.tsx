// FIX: Implemented the missing `ManageSchedulePage` component.
                ...
                <div className="bg-brand-surface rounded-lg shadow-lg overflow-hidden">
                    <div className="space-y-2 p-4">
                        {programs.length > 0 ? programs.map((program, index) => (
                             <div key={index} className="flex justify-between items-center p-3 rounded-md bg-slate-800 hover:bg-slate-700">
                                <div>
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <button onClick={() => handleDelete(index)} className="p-2 text-red-500 hover:bg-red-500/20 rounded-full" title={t('delete')}><Trash2 size={16}/></button>
                                </div>
                            </div>
                        )) : (
